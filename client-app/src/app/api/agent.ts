...
import { IActivity, IActiviesEnvelope } from "../models/activity";
import { history } from "../..";
...
const Activities = {
  ...
  attent: (id: string) => requests.post(`/activities/${id}/attend`, {}),
  unattent: (id: string) => requests.del(`/activities/${id}/attend`),
};
